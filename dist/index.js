...
console.log("=================================");
console.log(orderService.updateOrderStatus(1, OrderStatus.PAID));
...
// ==========================================
console.log("\nCambiar método de pago:");
console.log(orderService.updatePaymentMethod(1, PaymentMethod.TRANSFER));
console.log("\nPedido final:");
console.log(orderService.getOrderById(1));
// ==========================================
// ELIMINAR PRODUCTO
...
console.log("=================================");
console.log("Producto eliminado:", apiService.deleteProduct(3));
console.log("\nProductos finales:");
console.log(apiService.getProducts());
console.log("\n=================================");
